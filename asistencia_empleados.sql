...
-- Tiempo de generación: 14-05-2019 a las 02:43:33
...
(1, 'Ulises', 'Ancona', 'ua1998', '123456', 45.67, 1, 'Calle 25a x 36 y 38 Chenku', '0000-00-00', 'Masculino', 'Casado', 'AOGU2334455454545', '0000-00-00');
...
ALTER TABLE `dias_nomina_semanal`
  ADD PRIMARY KEY (`id_nomina_semanal`);
...
ALTER TABLE `solucion_pendientes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fkIdx_57` (`id_trabajo_diario`);
...
--
ALTER TABLE `dias_nomina_semanal`
  MODIFY `id_nomina_semanal` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `FK_75` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id`);

--
-- Filtros para la tabla `empleado_intentos`
--
ALTER TABLE `empleado_intentos`
  ADD CONSTRAINT `FK_30` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id`);

--
-- Filtros para la tabla `horarios`
--
ALTER TABLE `horarios`
  ADD CONSTRAINT `FK_37` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id`);

--
-- Filtros para la tabla `nomina_semanal`
--
ALTER TABLE `nomina_semanal`
  ADD CONSTRAINT `FK_67` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id`);

--
-- Filtros para la tabla `solucion_pendientes`
--
ALTER TABLE `solucion_pendientes`
  ADD CONSTRAINT `FK_57` FOREIGN KEY (`id_trabajo_diario`) REFERENCES `trabajo_diario` (`id`);

--
-- Filtros para la tabla `suspension_empleados`
--
ALTER TABLE `suspension_empleados`
  ADD CONSTRAINT `FK_90` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id`);

--
-- Filtros para la tabla `trabajo_diario`
--
ALTER TABLE `trabajo_diario`
  ADD CONSTRAINT `FK_46` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id`);

--
-- Filtros para la tabla `vacaciones_empleados`
--
ALTER TABLE `vacaciones_empleados`
  ADD CONSTRAINT `FK_82` FOREIGN KEY (`id_empleado`) REFERENCES `empleados` (`id`);
COMMIT;
